...
hw8: main.o term.o atom.o number.o struct.o variable.o number.o list.o global.o parser.o scanner.o shell.o exp.o
ifeq ($(OS), Windows_NT)
	g++ -o hw8 main.o term.o atom.o struct.o variable.o number.o list.o global.o parser.o scanner.o shell.o exp.o -lgtest
else
	g++ -o hw8 main.o term.o atom.o struct.o variable.o number.o list.o global.o parser.o scanner.o shell.o exp.o -lgtest -lpthread
endif
...
main.o:main.cpp expression.h exception.h exp.h
